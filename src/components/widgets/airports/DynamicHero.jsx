...
import { Phone, MapPin, ChevronDown, Plus, CalendarDays, Star } from "lucide-react";
import Header from "@/components/layout/Header";

// PIXEL PERFECT SHAPE PATH
        ...
        <div className="relative w-full grid grid-cols-1 lg:grid-cols-12 min-h-[600px] lg:h-[850px] overflow-hidden">
          ...
          <div className="col-span-1 lg:col-span-12 absolute inset-0 w-full h-full z-0 filter drop-shadow-2xl">
            <div
              ...
              style={{ clipPath: "url(#hero-rounded-clip)" }}
            >
          ...
          <div className="col-span-1 lg:col-span-12 relative z-40 w-full h-full pointer-events-none">
            <div className="pointer-events-auto w-full h-full flex flex-col pt-22 lg:pt-22">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 h-full px-4 lg:px-16 gap-12 lg:gap-0 pb-20">
                ...
                {/* STATIC RIGHT SIDE (Booking Form) */}
                  ...
                  <form className="bg-white rounded-[35px] p-8 w-full max-w-[420px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="relative flex flex-col gap-7 mb-10">
                      ...
                      <div className="relative group">
                        <div className="relative">
                          <input type="text" name="pickup" placeholder="Pick Up Address" className="w-full border-b-2 border-gray-200 py-3 text-sm font-semibold text-gray-800 placeholder-gray-800 focus:outline-none focus:border-[#bf1515] bg-transparent" />
                      ...
                      <div className="relative group">
                        <div className="relative">
                          <input type="text" name="via" placeholder="Via (Optional)" className="w-full border-b-2 border-gray-200 py-3 text-sm font-semibold text-gray-400 placeholder-gray-400 focus:outline-none focus:border-[#bf1515] bg-transparent" />
                          <ChevronDown className="absolute right-10 top-3 text-gray-400 w-4 h-4 pointer-events-none" />
                        </div>
                      ...
                      <div className="relative group">
                        <div className="relative">
                          <input type="text" name="dropoff" placeholder="Drop Off Address" className="w-full border-b-2 border-gray-200 py-3 text-sm font-semibold text-gray-800 placeholder-gray-800 focus:outline-none focus:border-[#bf1515] bg-transparent" />
                          <ChevronDown className="absolute right-10 top-3 text-gray-400 w-4 h-4 pointer-events-none" />
                        </div>
